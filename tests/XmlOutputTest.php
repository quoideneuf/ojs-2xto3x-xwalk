...
class XmlOutputTest extends PHPUnit\Framework\TestCase
{
	...
	public function testXml() {
		...
		$this->assertXPathEquals(
			"Brian",
			"//pkp:authors/pkp:author[@primary_contact='true']/pkp:givenname[@locale='en_US']"
		);
		...
		$this->assertXPathEquals(
			"submission",
			"//pkp:submission_file/@stage"
		);

		// unavailable in 2.x exports
		// $this->assertXPathEquals(
		// 	"1",
		// 	"//pkp:submission_file/pkp:revision/@id"
		// );

		$this->assertXPathEquals(
			"dummy.pdf",
			"//pkp:submission_file/pkp:revision/@filename"
		);

		$this->assertXPathEquals(
			$this->inlineFile(),
			"//pkp:submission_file/pkp:revision/pkp:embed[@encoding='base64']"
		);
